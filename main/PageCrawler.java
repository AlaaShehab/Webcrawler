...
public class PageCrawler implements Runnable{
    ...
    public void run() {
        try {
            // Add the current page to the processed list.
            crawler.addProcessedPage(page);

            List<String> links = new ArrayList<>();
            // Connect to the website i.e. page provided.
            ...
            for (Element page : linksOnPage) {
                ...
                // Add a new page to the list only if it has the same domain
                // as starting site and is not visited before.
